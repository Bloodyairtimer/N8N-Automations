...
When you start building Flutter apps, numeric values appear everywhere—counters, prices, dimensions, animation offsets. Dart keeps the story simple with just two core numeric types, but the way those types behave in arithmetic, parsing, and display can become a source of subtle bugs if you're not careful. Let's walk through what you actually need to know.

## The Two Types You'll Use Daily
